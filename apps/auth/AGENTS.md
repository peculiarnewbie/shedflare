# Shedflare Auth – Agent Guidance

This directory contains the optional Shedflare Auth deployment inside the canonical monorepo. Keep
it independently selectable, testable, and deployable through scoped workspace commands.
...
- Treat the allowed-client map as an explicit security boundary; every client ID and origin must be validated.
