    ...
    <div class="page">
      ...
      <div class="stats-grid">
        <div class="stat-card">
          ...
          <div class="stat-value positive">${(netWorth() / 100).toLocaleString("en-US", { minimumFractionDigits: 2 })}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">On Budget</div>
          <div class="stat-value positive">${(onBudgetAmount() / 100).toLocaleString("en-US", { minimumFractionDigits: 2 })}</div>
        </div>
        <div class="stat-card">
      ...
      <div class="section">
        ...
        <div class="stats-grid">
          <div class="stat-card income">
            ...
            <div class="stat-value positive">${(monthIncome() / 100).toLocaleString("en-US", { minimumFractionDigits: 2 })}</div>
          </div>
          <div class="stat-card expense">
            <div class="stat-label">Expenses</div>
            <div class="stat-value negative">${(monthExpense() / 100).toLocaleString("en-US", { minimumFractionDigits: 2 })}</div>
          </div>
          <div class="stat-card">
            <div class="stat-label">Balance</div>
            <div class="stat-value" classList={{
              positive: (monthIncome() - monthExpense()) >= 0,
              negative: (monthIncome() - monthExpense()) < 0,
            }}>
              ${((monthIncome() - monthExpense()) / 100).toLocaleString("en-US", { minimumFractionDigits: 2 })}
            </div>
          </div>
        </div>
      </div>
