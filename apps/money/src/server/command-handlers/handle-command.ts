...
export function handleCommand(
  ...
  const access = new DataAccess(db, drizzle);

  try {
    const payload = (decodeCommand as any)(commandType, body.payload ?? body);
    return routeCommand(commandType, payload, access);
  } catch (e) {
    return { ok: false, error: e instanceof Error ? e.message : "Validation failed" };
  }
}

function routeCommand(commandType: string, payload: any, access: DataAccess): CommandResult {
  switch (commandType) {
    case "create_account":
    case "update_account":
    case "delete_account":
    ...
    case "update_exchange_rate":
      return handleAccountCommands(commandType, payload, access);

    case "create_transaction":
    case "update_transaction":
    case "delete_transaction":
    case "split_transaction":
      return handleTransactionCommands(commandType, payload, access);
    ...
    case "hold_for_next_month":
      return handleBudgetCommands(commandType, payload, access);

    case "create_payee":
    case "update_payee":
    case "merge_payees":
      return handlePayeeCommands(commandType, payload, access);
    ...
    case "post_schedule_transaction":
      return handleScheduleCommands(commandType, payload, access);

    case "create_rule":
    case "update_rule":
    case "delete_rule":
      return handleRuleCommands(commandType, payload, access);

    case "create_tag":
    case "delete_tag":
    case "add_transaction_tag":
    case "remove_transaction_tag":
      return handleTagCommands(commandType, payload, access);

    case "import_transactions":
      return handleImportCommands(commandType, payload, access);

    case "create_filter":
    case "update_filter":
    case "delete_filter":
      return handleFilterCommands(commandType, payload, access);

    case "create_report":
    case "update_report":
    case "delete_report":
      return handleReportCommands(commandType, payload, access);

    case "update_setting":
      return handleSettingCommands(commandType, payload, access);
