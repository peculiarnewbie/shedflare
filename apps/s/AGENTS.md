# Shedflare Links – Agent Guidance

This directory contains Shedflare Links inside the canonical monorepo. Its app ID remains `s` for
compatibility. Keep it independently selectable, testable, buildable, and deployable through scoped
workspace commands.
